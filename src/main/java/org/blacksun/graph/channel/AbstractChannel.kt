...
abstract class AbstractChannel(override val fromNode: GraphNode, override val toNode: GraphNode, override var weight: Int, override var errors: Double) : Channel {
